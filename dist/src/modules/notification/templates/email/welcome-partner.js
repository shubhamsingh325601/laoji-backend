...
exports.welcomePartnerEmail = welcomePartnerEmail;
const email_layout_1 = require("./email-layout");
function welcomePartnerEmail(params) {
  ...
  `;
    return {
        ...
        html: (0, email_layout_1.wrapInLaojiEmailLayout)(html, 'Welcome to Laoji Delivery Fleet! Start accepting rides.'),
    };
}
//# sourceMappingURL=welcome-partner.js.map