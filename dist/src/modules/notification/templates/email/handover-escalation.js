...
exports.handoverEscalationEmail = handoverEscalationEmail;
const email_layout_1 = require("./email-layout");
function handoverEscalationEmail(params) {
  ...
  `;
    return {
        ...
        html: (0, email_layout_1.wrapInLaojiEmailLayout)(html, `Delivery Handover Escalation for Order #${params.orderCode}`),
    };
}
//# sourceMappingURL=handover-escalation.js.map