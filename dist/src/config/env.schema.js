...
exports.envSchema = zod_1.z.object({
    ...
    JWT_ACCESS_EXPIRES_IN: zod_1.z.preprocess(cleanString, zod_1.z.string().default('7d')),
    JWT_REFRESH_EXPIRES_IN: zod_1.z.preprocess(cleanString, zod_1.z.string().default('90d')),
