...
export function welcomeCustomerEmail(params: { name?: string; phone?: string; email?: string }): EmailMessage {
  ...
  return {
    ...
    html: wrapInLaojiEmailLayout(html, 'Welcome to Laoji! Start shopping today.'),
  };
}
